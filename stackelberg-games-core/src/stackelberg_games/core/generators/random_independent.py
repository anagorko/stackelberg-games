...
class RandomIndependentGameGenerator(GameGenerator):
    """
    Independent payoff matrices with payoffs sampled with uniform probability from [-1.0, 1.0] interval.
    """
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, RandomIndependentGameGenerator):
            return False
